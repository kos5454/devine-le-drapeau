...
// ─────────────────────────────────────────────────────────────────
//  GAME HISTORY  (clé partagée avec script.js)
// ─────────────────────────────────────────────────────────────────
...
function showResults() {
  ...
  saveGameHistory({
    game: "capitals", mode: m, continent: state.continent,
...
if (_revParam === "capitals") {
  const _weakCodes = getWeakCountryCodes("capitals");
